...
const forumTimeToTimestamp = require('./utils').forumTimeToTimestamp;
const setErrorCode = require('./utils').setErrorCode;

const unreadURL = 'https://www.thmmy.gr/smf/index.php?action=unread;all';

exports.fetchUnreadPosts = async function(options) {
        ...
        try {
            ...
            $('table[class=bordercolor][cellspacing="1"]')
                ...
                .each(function() {
                    ...
                    timestamp = forumTimeToTimestamp(/.+/i.exec(timeAndPoster)[0]);
